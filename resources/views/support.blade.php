...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-8" style="margin-top: 3rem;">
            <h3 class="text-dark mt-4 text-center mb-4 pb-2">If you have any query/Faq email us at <a style="color: #f98513" href="mailto:support@tbe-web.com">support@tbe-web.com</a> </h3>
