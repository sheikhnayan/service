        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-md-12 mb-4">
              <h3 class="text-dark">Latest Service</h3>
            </div>
            ...
            <div class="col-md-12 mt-4 p-4">
              <a href="{{ route('user.service.all',[$data->id]) }}" class="text-dark" style="text-decoration: underline; font-weight: 500">View All Service</a>
            </div>
          </div>
          <div class="row" style="margin-top: 4rem;">
            <div class="col-md-12 mb-4">
              <h3 class="text-dark">Latest Product</h3>
            </div>
