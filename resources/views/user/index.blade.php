...
@section('content')
    <div class="row p-4">
        ...
        <div class="col-md-1">
            ...
            <p class="text-center mt-2" style="width: 70px;"> <a class="text-dark" href="{{ route('user.product-category',[0]) }}"> All </a> </p>
        </div>
    ...
    <div class="row p-4">
        ...
        <div class="col-md-1">
            ...
            <p class="text-center mt-2" style="width: 70px;"> <a class="text-dark" href="{{ route('user.food-category',[0]) }}"> All </a> </p>
        </div>
    ...
    <div class="row p-4">
        ...
        <div class="col-md-1">
            ...
            <p class="text-center mt-2" style="width: 70px;"> <a class="text-dark" href="{{ route('user.service-category',[0]) }}"> All </a> </p>
        </div>
