      ...
      <div class="row justify-content-center">
        <div class="col-md-3">
          <form action="{{ route('vendor.service.update',[$data->id]) }}" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="link" value="{{ $data->link }}" class="form-control" placeholder="Service Booking URL" style="border:unset; border-bottom: 2px solid black; font-size:17px;">
