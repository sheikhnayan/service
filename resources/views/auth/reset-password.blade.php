        ...
        <div class="page-wrapper" style="padding-left: 0px !important">
            ...
            <header class="main-header " id="header" style="padding: 0px">
                <nav class="navbar navbar-static-top navbar-expand-lg">
                    ...
                    <div class="navbar-right ml-auto">
                        <a href="/vendor-register" class="btn btn-success" style="padding: 12px 25px;"> Register
                        </a>
                    </div>
                </nav>
                            ...
                            <form method="POST" action="{{ route('password.update') }}">
                                ...
                                <div class="form-group mt-4">
                                    <div class="input-group input-group-sm">
                                        <input type="email" placeholder="Email"
                                            ...
                                            style="border:unset; border-bottom: 2px solid black; font-size:17px;" name="email" value="{{ $request->email }}" required>
                                ...
                                <div class="form-group">
                                    <input type="password" name="password" class="form-control mt-4" placeholder="New Password"
                                        ...
                                        <img id="togglePassword" class="img-fluid" src="{{ asset('vendor_panel/eye.png') }}" style="position: absolute; top: 85px; right: 20px; cursor:pointer">
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="password" name="password_confirmation" class="form-control mt-4" placeholder="Confirm Password"
                                        ...
                                        <img id="togglePassword2" class="img-fluid" src="{{ asset('vendor_panel/eye.png') }}" style="position: absolute; top: 150px; right: 20px; cursor:pointer">
                                </div>
                    
                                <button  type="submit" class="btn btn-success mt-4 logout-profile">Reset Password</button>
                            </form>
                        </div>
                    </div>
                </div>
