                        ...
                        <div class="col-md-6">
                            <form action="{{ route('password.email') }}" method="post">
                                ...
                                <h4 class="ml-2 text-dark"
                                    style="font-family:Montserrat; font-weight:bold;line-height:2.3;">Enter your email
                                </h4>
                                ...
                                <button  type="submit" class="btn btn-success mt-4 logout-profile">Submit</button>
